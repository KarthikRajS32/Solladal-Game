...
//     <div>
//       {/* Header */}
//       <div className="flex justify-evenly items-center text-center bg-green-800 text-white shadow-lg shadow-gray-400">
//         <button
//           onClick={() => setShowRules(true)}
//           className="text-3xl w-10 h-10 border-2 border-gray-300 rounded-full cursor-pointer transform hover:scale-110 transition duration-200"
//         >
//           ?
//         </button>
//         <h1 className="text-3xl font-bold sm:text-4xl md:text-5xl rubik-distressed-regular text-center p-4 sm:p-6">
//           சொல்லாடல்
//         </h1>
//         <button
//         onClick={() => window.location.reload()}
//          className="border-2 border-gray-300 w-30 rounded-lg cursor-pointer transform hover:scale-102 transition duration-200">மீண்டும் விளையாடு</button>
//       </div>

//       {/* Game Rules Modal */}
//       {showRules && (
//         <div className="fixed inset-0 bg-black flex justify-center items-center z-50">
//           <div className="bg-white p-6 rounded-lg w-11/12 max-w-xl text-black">
//             <div className="flex justify-between items-center mb-4">
//               <h2 className="text-xl font-bold">எப்படி விளையாடுவது</h2>
//               <button
//                 onClick={() => setShowRules(false)}
//                 className="text-xl font-bold px-3 py-1 cursor-pointer rounded-full hover:bg-gray-300"
//               >
//                 ×
//               </button>
//             </div>
...
//             <hr className="my-4" />
//             <h3 className="font-semibold mb-2">நிற குறிப்புகள்</h3>
...
//                   தெ
//                 </div>
//                 <div className="border px-2 py-1">ன்</div>
//                 <div className="border px-2 py-1">ற</div>
//                 <div className="border px-2 py-1">ல்</div>
//               </div>
...
//             <div className="mb-2">
//               <div className="flex space-x-2">
//                 <div className="border px-2 py-1">மி</div>
//                 <div className="bg-yellow-400 text-white px-2 py-1 rounded">
//                   ன்
//                 </div>
//                 <div className="border px-2 py-1">ன</div>
//                 <div className="border px-2 py-1">ல்</div>
//               </div>
//               <p className="text-sm mt-1">
...
//             <div className="mb-2">
//               <div className="flex space-x-2">
//                 <div className="border px-2 py-1">அ</div>
//                 <div className="border px-2 py-1">ச்</div>
//                 <div className="border px-2 py-1">ச</div>
//                 <div className="bg-gray-400 text-white px-2 py-1 rounded">
//                   ம்
//                 </div>
//               </div>
//               <p className="text-sm mt-1">
  ...
  return (
    <div>
      ...
      <div className="flex justify-between sm:justify-evenly items-center text-center bg-green-800 text-white shadow-lg shadow-gray-400 px-2 sm:px-4">
        ...
        {/* <button
          onClick={() => window.location.reload()}
          className="text-[10px] xs:text-xs sm:text-base border-2 border-gray-300 px-1.5 py-0.5 xs:px-2 xs:py-1 sm:px-4 sm:py-2 rounded-lg cursor-pointer transform hover:scale-102 transition duration-200"
        >
          மீண்டும் விளையாடு
        </button> */}
